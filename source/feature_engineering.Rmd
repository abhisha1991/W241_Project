...
dTQ2$TreatmentQ2 = generateRandomIntNums(nrow(dTQ2), 2, 2) # WM WF
dTQ3$TreatmentQ3 = generateRandomIntNums(nrow(dTQ3), 5, 1) # WM BF
dTQ4$TreatmentQ4 = generateRandomIntNums(nrow(dTQ4), 3, 1) # WF BM
dTQ5$TreatmentQ5 = generateRandomIntNums(nrow(dTQ5), 3, 1) # BM BF
dTQ6$TreatmentQ6 = generateRandomIntNums(nrow(dTQ6), 1, 1) # WF BF
...
dCQ2$ControlQ2 = generateRandomIntNums(nrow(dCQ2), 3, 2)
dCQ3$ControlQ3 = generateRandomIntNums(nrow(dCQ3), 4, 2)
dCQ4$ControlQ4 = generateRandomIntNums(nrow(dCQ4), 3, 1)
dCQ5$ControlQ5 = generateRandomIntNums(nrow(dCQ5), 4, 1)
dCQ6$ControlQ6 = generateRandomIntNums(nrow(dCQ6), 2, 1)
